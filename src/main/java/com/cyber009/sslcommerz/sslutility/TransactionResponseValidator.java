 ...
 * page.
 * Validates those parameters fetched from payment page response and returns
 * true for successful transaction
 * and false otherwise.
 */
public class TransactionResponseValidator {
     ...
     * @return
     * @throws Exception
     *                   Send Received params from your success resoponse (POST ) in
     *                   this Map</>
     */
    public boolean receiveSuccessResponse(Map<String, String> request) throws Exception {
         ...
         * success.
         * if this following validation returns false , then query status if failed of
         * canceled.
