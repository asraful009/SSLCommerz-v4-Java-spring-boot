...
import com.cyber009.sslcommerz.sslutility.Utility.ParameterBuilder;

/**
 * This class initiates a transaction request to SSL Commerz
 * required parameters to hit SSL Commerz payment page are constructed in a Map
 * of String as key value pair
 * Its method initTrnxnRequest returns JSON list or String with Session key
 * which then used to select payment option
 */
public class TransactionInitiator {
    public String initTrnxnRequest() {
        ...
        try {
            /**
             * All parameters in payment order should be constructed in this follwing
             * postData Map
            ...
            /**
             * If user want to get Gate way list then pass isGetGatewayList parameter as
             * true
